...
const actionHandler = (definition) => {
    return (state, action, handler) => {
        ...
        const newDefinition = Object.assign(Object.assign({}, definition), { handlers: Object.assign(Object.assign({}, definition.handlers), { [untypedState]: Object.assign(Object.assign({}, (definition.handlers[untypedState] ? definition.handlers[untypedState] : {})), { [untypedAction]: handler }) }) });
